...
Las reglasde elegibilidad so estrictas:
...
function main() {
    ...
    const assistantGrade = prompt('Assistant grade: ').toUpperCase()

    const isEligible = validateScholarship(grade1, grade2, grade3, grade4, assistantGrade)
    if (isEligible){
        console.log('Congrats, you are eligible for the scholarchip.')
    }   else {
