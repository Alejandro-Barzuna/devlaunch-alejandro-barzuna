...
Esta clase incluirá dos métodos clave: un "getter" para recuperar el salarioactual y un "setter"
...
const emp1 = new Employee ('alejandro', 'barzuna', 200)
console.log(emp1._firstName)
console.log(emp1._lastName)
